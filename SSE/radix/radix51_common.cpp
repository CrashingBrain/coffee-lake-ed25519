...
void _ureduce128wide(limb_t* _z0, limb_t* _z1, limb_t* _z2, limb_t* _z3, limb_t* _z4, limb_t*z){
  __m128i _13 = _mm_set_epi64x(13, 13);
  __m128i _51 = _mm_set_epi64x(51, 51);
  __m256i _rmask = _mm256_set_epi64x(RADIXMASK51, RADIXMASK51, RADIXMASK51, RADIXMASK51);
  
  __m256i _t01230 = _mm256_set_epi64x(_z3[0], _z2[0], _z1[0], _z0[0]);
  limb_t _t40 = _z4[0];
  __m256i _t01231 = _mm256_set_epi64x(_z3[1], _z2[1], _z1[1], _z0[1]);
  limb_t _t41 = _z4[1];
  
  __m256i _r01230 = _mm256_sll_epi64(_t01230, _13);
  limb_t _r40 = _t40 << 13;
  __m256i _r01231 = _mm256_srl_epi64(_t01231, _51);
   limb_t _r41 = _t41 >> 51;
  
  __m256i _z01230 = _mm256_or_si256(_r01230, _r01231);
  limb_t _z40 = _r40 | _r41;
  __m256i _z01231 = _mm256_and_si256(_t01231, _rmask);
  limb_t _z41 = _t41 & RADIXMASK51;
  
  
  limb_t _z01230arr[4];
  limb_t _z01231arr[4];
  _mm256_storeu_si256((__m256i *)&_z01230arr[0], _z01230);
  _mm256_storeu_si256((__m256i *)&_z01231arr[0], _z01231);
  
  limb_t z3 = _z01231arr[3] + _z40;
  limb_t z2 = _z01231arr[2] + _z01230arr[3];
  limb_t z1 = _z01231arr[1] + _z01230arr[2];
  limb_t z0 = _z01231arr[0] + _z01230arr[1];
  limb_t z4 = _z41 + 19*_z01230arr[0];
