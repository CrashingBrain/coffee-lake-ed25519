...
* The array is up to user to free.
*/
ulli* r51toulli(const r51_t* r){
  ulli* foo = (ulli*) malloc(4*sizeof(ulli));
  foo[3] = (r->limbs[4])      | (r->limbs[3]<<51);
  foo[2] = (r->limbs[3]>>13)  | (r->limbs[2]<<38);
  foo[1] = (r->limbs[2]>>26)  | (r->limbs[1]<<25);
  foo[0] = (r->limbs[1]>>39)  | (r->limbs[0]<<12);
  return foo;
}
...
// TODO : I need to test that, or figure out a better way to do it
